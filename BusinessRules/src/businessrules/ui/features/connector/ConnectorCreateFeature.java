...
public class ConnectorCreateFeature extends AbstractCreateConnectionFeature implements IPaletteEntry {

	public ConnectorCreateFeature(IFeatureProvider fp, String name, String description) {
	...
	private EBaseStep createConnector(EBaseStep source, EBaseStep target) {
		...
		connector.setDiagramType(DiagramTypeConstants.Const_Connector);
	...
	public String getIconId() {
		return ImageProvider.ICON_LINK_FLOW;
	}
}
